...
27. Connect the DC Jack to the Arduino to allow the sensor and screen to be battery operated (9V batteries).
28. If creating connection between DC jack and battery holder, connect dashed wire at the jack to the positive wire from the batteries. Solder the other wire at the jack to the negative wire from the batteries. Refer to image below.<img width="750" height="563" alt="image" src="https://github.com/user-attachments/assets/4a3ebee3-4488-4fd2-a674-ede2ff99d36a" />
